...
\begin{minipage}[t]{\textwidth}
	...
	\begin{itemize}[noitemsep,topsep=0pt]
		...
		% \item Led implementation of account \textbf{2FA} through requiring the random six-digit
		% code sent to their verified emails or phone numbers to be used in sign-on.
		% 	Includes remember device for thirty days cookie.
	\end{itemize}
	\vspace{0.3em}
